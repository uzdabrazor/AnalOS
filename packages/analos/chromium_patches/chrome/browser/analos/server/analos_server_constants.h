diff --git a/chrome/browser/analos/server/analos_server_constants.h b/chrome/browser/analos/server/analos_server_constants.h
new file mode 100644
index 0000000000000..d2c8229f8c805
--- /dev/null
+++ b/chrome/browser/analos/server/analos_server_constants.h
@@ -0,0 +1,52 @@
+// Copyright 2024 The Chromium Authors
+// Use of this source code is governed by a BSD-style license that can be
+// found in the LICENSE file.
+
+#ifndef CHROME_BROWSER_ANALOS_SERVER_ANALOS_SERVER_CONSTANTS_H_
+#define CHROME_BROWSER_ANALOS_SERVER_ANALOS_SERVER_CONSTANTS_H_
+
...
+    "https://cdn.uzdabrazor.com/appcast-server.xml";
+inline constexpr char kAlphaAppcastUrl[] =
+    "https://cdn.uzdabrazor.com/appcast-server.alpha.xml";
+
...
+}  // namespace analos_server
+
+#endif  // CHROME_BROWSER_ANALOS_SERVER_ANALOS_SERVER_CONSTANTS_H_
