...
index 85e1db9929325..35c91e53c07dc 100644
--- a/chrome/browser/resources/settings/settings.ts
+++ b/chrome/browser/resources/settings/settings.ts
@@ -32,6 +32,8 @@ export {OpenWindowProxy, OpenWindowProxyImpl} from 'chrome://resources/js/open_w
...
+export {SettingsAnalOSPrefsPageElement} from './analos_prefs_page/analos_prefs_page.js';
