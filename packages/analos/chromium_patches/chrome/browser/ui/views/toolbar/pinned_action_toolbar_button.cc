...
+  // Update the text from the action item for AnalOS actions
+  if (analos::IsAnalOSAction(action_view_->GetActionId())) {
+    // Check if labels should be shown
+    bool show_labels = true;
