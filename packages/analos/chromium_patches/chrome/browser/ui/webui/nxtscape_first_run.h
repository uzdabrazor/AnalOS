...
+ <p>AnalOS is an AI-powered browser that lets you build and run agents to automate tedious tasks. It looks like Chrome but reimagined for the AI era.</p>
+</section>
+
+<section>
+ <div class="section-head"><span class="label">🚀 Getting Started</span></div>
+ <div style="text-align:center;">
+  <a class="btn btn-accent" href="https://bit.ly/AnalOS-setup">Quick start guide</a>
...
+   <p class="muted" style="margin-top:.35rem">Once setup completes (~1–2 min), visit <code>chrome://analos/settings</code> to configure your API keys.</p>
...
+   Step 3: All done!
+  </div>
+  <div class="muted" style="margin-top:.4rem">You're ready to use AnalOS, have fun! This page can be always accessed again at <a href="chrome://analos-first-run"><code>chrome://analos-first-run</code></a></div>
+ </div>
+</section>
+
+<section>
...
+   Discord
+  </a>
+  <a href="https://github.com/uzdabrazor/AnalOS">
+   <span class="icon" aria-hidden="true">
+    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
+     <title>GitHub</title>
...
+   GitHub
+  </a>
+  <a href="https://dub.sh/analOS-slack">
+   <span class="icon" aria-hidden="true">
+    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
+     <title>Slack</title>
...
+  public:
+   NxtscapeFirstRunUIConfig() : DefaultWebUIConfig("chrome", "analos-first-run") {}
+};
+
