...
index f9088ac701027..2b38cd3cecf26 100644
...
+const char kAnalOsAlphaFeaturesName[] = "AnalOS Alpha Features";
+const char kAnalOsAlphaFeaturesDescription[] =
+    "Enables AnalOS alpha features.";
+
