#!/usr/bin/env python3
"""Release CLI - Modular release automation for AnalOS"""
...
def main(
    ...
    """Release automation for AnalOS

    \b
    Quick Operations (Flags):
      analos release --list                        # List all available versions
      analos release --list --version 0.31.0       # List artifacts for version
      analos release --version 0.31.0 --appcast    # Generate appcast XML
      analos release --version 0.31.0 --publish    # Publish to download/ paths
      analos release --version 0.31.0 --download   # Download all artifacts
      analos release --version 0.31.0 --download --os macos  # Download macOS only
      analos release --version 0.31.0 --download --output ./downloads  # Custom dir

    \b
    GitHub Release (Sub-command):
      analos release github create --version 0.31.0
      analos release github create --version 0.31.0 --publish

    \b
    Show Available Modules:
      analos release --show-modules
    """
    if show_modules:
...
def github_create(
    ...
    Examples:
      analos release github create --version 0.31.0
      analos release github create --version 0.31.0 --publish  # Also publish to download/
      analos release github create --version 0.31.0 --no-draft # Create published release
    """
