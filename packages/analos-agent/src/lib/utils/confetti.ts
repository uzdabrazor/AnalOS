...
(() => {
  ...
  container.id = 'analos-confetti-container';
  ...
  style.id = 'analos-confetti-styles';
  style.textContent = \`
  ...
  setTimeout(() => {
    const containerEl = document.getElementById('analos-confetti-container');
    const styleEl = document.getElementById('analos-confetti-styles');
