...
const processEnv = {
  ...
  'process.env.BRAINTRUST_PROJECT_NAME': JSON.stringify(envKeys.BRAINTRUST_PROJECT_NAME || 'analos-agent-online'),
...
module.exports = {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      template: './analos-settings.html',
      filename: 'analos-settings.html',
      chunks: ['options']
    }),
    new HtmlWebpackPlugin({
