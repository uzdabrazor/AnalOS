...
description: "Configure LM Studio to run local LLMs with AnalOS"
icon: "desktop"
---
...
<Steps>
  ...
  <Step title="Configure in AnalOS">
    ...
    <Frame>
      ![Configure in AnalOS](/images/setting-up-lm-studio/lmstudio-step3.png)
    </Frame>
  </Step>
  ...
  <Step title="Use the Model">
    Select the model in AnalOS agent and start using it! 🎉

    <Frame>
      ![Use the model in AnalOS](/images/setting-up-lm-studio/lmstudio-step5.png)
    </Frame>
  </Step>
</Steps>

<Warning>
  Ensure the Context Window Size in AnalOS matches what you configured in LM Studio to avoid issues with long conversations.
</Warning>
