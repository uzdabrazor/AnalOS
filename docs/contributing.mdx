---
title: "Contributing to AnalOS"
description: "Let's build the best open-source browser!"
icon: "code-branch"
---

Hey there! Thanks for your interest in AnalOS. Whether you're fixing bugs, adding features, improving docs, or just poking around the code, we're glad you're here.

AnalOS is a monorepo with two main parts:
...
<CardGroup cols={3}>
  <Card
    ...
    icon="github"
    href="https://github.com/uzdabrazor/AnalOS"
  >
  ...
  <Card
    title="Report Issues"
    icon="bug"
    href="https://github.com/uzdabrazor/AnalOS/issues"
  >
...
You can contribute to AnalOS in many ways! Whether you want to build features or help out in other ways, we appreciate all contributions.

<Tabs>
  <Tab title="🐛 Report Bugs">
    Found a bug? [Open an issue](https://github.com/uzdabrazor/AnalOS/issues/new) with:
    - Clear description
    - Steps to reproduce
    - Expected vs actual behavior
    - Screenshots/videos
    - Environment details (OS, browser version, AnalOS version)
  </Tab>

  <Tab title="💡 Suggest Features">
    Have an idea? [Share it here](https://github.com/uzdabrazor/AnalOS/issues/99) or chat with us on [Discord](https://discord.gg/YKwjt5vuKr).
  </Tab>
...
<Steps>
  ...
  <Step title="Load Unpacked Extension">
    Click **Load unpacked** and select `packages/analos-agent/dist/`
  </Step>
...
<Note>
For detailed setup, architecture, and code standards, see the [Agent Contributing Guide](https://github.com/uzdabrazor/AnalOS/blob/main/packages/analos-agent/CONTRIBUTING.md).
</Note>
...
<Steps>
  ...
  <Step title="Run AnalOS">
    After the build completes successfully, you can run AnalOS:

    <Tabs>
      <Tab title="macOS Debug (ARM64)">
        ```bash
        out/Default_arm64/AnalOS\ Dev.app/Contents/MacOS/AnalOS\ Dev --user-data-dir=/tmp/test-profile
        ```
      </Tab>
      <Tab title="macOS Debug (x64)">
        ```bash
        out/Default_x64/AnalOS\ Dev.app/Contents/MacOS/AnalOS\ Dev --user-data-dir=/tmp/test-profile
        ```
      </Tab>
      <Tab title="macOS Release (ARM64)">
        ```bash
        out/Default_arm64/AnalOS.app/Contents/MacOS/AnalOS --user-data-dir=/tmp/test-profile
        ```
      </Tab>
      <Tab title="macOS Release (x64)">
        ```bash
        out/Default_x64/AnalOS.app/Contents/MacOS/AnalOS --user-data-dir=/tmp/test-profile
        ```
      </Tab>
...
<Steps>
  <Step title="Read the CLA">
    Read the [CLA document](https://github.com/uzdabrazor/AnalOS/blob/main/CLA.md)
  </Step>
...
- Agent: [packages/analos-agent/CLAUDE.md](https://github.com/uzdabrazor/AnalOS/blob/main/packages/analos-agent/CLAUDE.md)
</Note>
...
<Steps>
  <Step title="Fork and Clone">
    ...
    ```bash
    git clone https://github.com/YOUR-USERNAME/AnalOS.git
    cd AnalOS
    ```
  </Step>
...
<CardGroup cols={3}>
  ...
  <Card
    ...
    icon="comments"
    href="https://github.com/uzdabrazor/AnalOS/discussions"
  >
    General questions
  </Card>
</CardGroup>
