---
title: "OpenAI"
description: "Configure AnalOS to use OpenAI's GPT models"
---
...
Navigate to `chrome://analos/settings` or click the **Settings** icon on the new tab page, then click **USE** on the OpenAI card. Paste your API key and configure the settings based on your chosen model. For GPT-4.1, set **Context Window Size** to `128000` and check **Supports Images**. Click **Save**.

![image.png](/docs/images/image.png)

Done! You're ready to use AnalOS with OpenAI.