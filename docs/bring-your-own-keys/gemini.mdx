---
title: "Gemini"
description: "Configure AnalOS to use Google's Gemini AI model"
---

Gemini 2.5 Flash is fast, powerful, and free. Google AI Studio gives you 20 requests per minute at no cost - perfect for AnalOS.
...
Navigate to `chrome://analos/settings` or click the **Settings** icon on the new tab page, then click **USE** on the Gemini card.
...
Done! You're ready to use AnalOS with Gemini.